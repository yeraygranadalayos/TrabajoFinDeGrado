# -*- coding: utf-8 -*-
"""
Created on Sun Oct 18 19:16:39 2020
...
def train_naive_bayes(features, label):
    ...
    print ('Finished the Naive Bayes model')
    return GNB_model

GNB_model = train_naive_bayes(tfidf_features, y_train)
...
predicted_y = GNB_model.predict(test_data_tfidf_features)
